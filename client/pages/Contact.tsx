...
import { MapPin, Phone, Mail, Clock, ArrowLeft, MessageCircle, Users, Award } from "lucide-react";
      ...
      <section className="bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Liên hệ với
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent"> chúng tôi</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Chúng tôi luôn sẵn sàng hỗ trợ bạn. Hãy liên hệ để được tư vấn về khóa học 
            hoặc giải đáp mọi thắc mắc.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <Card className="border-0 shadow-xl">
              <CardHeader>
                ...
                <p className="text-gray-600">Điền thông tin bên dưới và chúng tôi sẽ phản hồi trong vòng 24 giờ.</p>
              </CardHeader>
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" placeholder="Nhập họ của bạn" className="h-11" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName">Tên *</Label>
                      <Input id="lastName" placeholder="Nhập tên của bạn" className="h-11" />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="phone" type="tel" placeholder="0901 234 567" className="h-11" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="course-consultation">Tư vấn khóa học</SelectItem>
                        <SelectItem value="technical-support">Hỗ trợ kỹ thuật</SelectItem>
                        <SelectItem value="instructor-partnership">Hợp tác giảng viên</SelectItem>
                        <SelectItem value="business-partnership">Hợp tác doanh nghiệp</SelectItem>
                        <SelectItem value="feedback">Góp ý và phản hồi</SelectItem>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="consent" className="text-sm text-gray-600">
                      Tôi đồng ý với việc YogaFlow sử dụng thông tin này để liên hệ và hỗ trợ tôi.
                    </Label>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-900">Thông tin liên hệ</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
            ...
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-900">Hỗ trợ nhanh</CardTitle>
              </CardHeader>
            ...
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-900">Theo dõi chúng tôi</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <Button variant="outline" className="h-12 p-2">
                    <img src="/placeholder.svg" alt="YouTube" className="w-6 h-6" />
                  </Button>
                </div>
                <p className="text-sm text-gray-600 mt-4">
                  Theo dõi chúng tôi để cập nhật những thông tin mới nhất về yoga và sức khỏe.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tìm chúng tôi</h2>
            <p className="text-gray-600">Văn phòng chính tại trung tâm thành phố</p>
          </div>
            ...
            {[
              {
                ...
                answer: "Bạn có thể đăng ký trực tiếp trên website hoặc liên hệ hotline 1900 123 456 để được hỗ trợ."
              },
              {
                question: "Tôi có thể học lại bài đã học không?",
                answer: "Có, bạn có thể truy cập và học lại bất kỳ bài nào trong khóa học của mình không giới hạn số lần."
              },
              {
                question: "Có chính sách hoàn tiền không?",
                answer: "Có, chúng tôi có chính sách hoàn tiền 100% trong vòng 30 ngày đầu nếu bạn không hài lòng."
              },
              {
                question: "Tôi cần thiết bị gì để tập yoga?",
                answer: "Bạn chỉ cần một tấm thảm yoga và không gian thoải mái. Các dụng cụ khác sẽ được hướng dẫn trong từng bài học."
              }
            ].map((faq, index) => (
